...
function Brush() {
	...
	const datatypes = 'ATOM BOOL BOOLEAN BYTE CHAR COLORREF DWORD DWORDLONG DWORD_PTR ' +
	...
	const keywords = 'alignas alignof auto break case catch class const constexpr decltype __finally __exception __try ' +
	...
	const functions = 'assert isalnum isalpha iscntrl isdigit isgraph islower isprint ' +
